...
function RegisterExpressEndpoints(app, io, logger) {
    ...
    function CaptureStateChangeNotificationCallback(data) {
        ...
        switch(data.captureMode) {
            ...
            case 101:
                // Highlights
                endpoint = '/ShadowPlay/v.1.0/Notification'
                switch (data.recordingState) {
                    case 0x00:
                        result = { notification : "highlightSession", active: false };                       
                        break;
                    case 0x01:
                        result = { notification: "highlightSession", active: true };
                        break;
                    default:
                        logger.error('Unhandled highlights state: ' + data.recordingState);
                        break;
                }
                break;
            default:
    ...
    return {
        ...
        initialize: function () {
            return new Promise(function CreateInitializationPromise(resolve, reject) {
                ...
                logger.info('NvShadowPlayAPI module initialized');
            });
        }
    };
};
