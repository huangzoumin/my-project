...
//                HttpHost proxy = new HttpHost(propsIP.getProperty(key1));
                ...
                HttpHost target = new HttpHost(propsHttpURI.getProperty(key2), 80, "http");
...
//                HttpGet request = new HttpGet(propsHttpURI.getProperty(key2));
        ...
        for (String key1 : propsIP.stringPropertyNames()) {
            ...
            for (String key2 : propsHttpsURI.stringPropertyNames()) {
                ...
                HttpHost target1 = new HttpHost(propsHttpsURI.getProperty(key2), 443, "https");
                HttpHost proxy1 = new HttpHost(propsIP.getProperty(key1), 443, "https");
                ...
                //打印目标地址和代理ip
                System.out.println("Executing request " + httpGet.getRequestLine() + " to " + target1 + " via " + proxy1);
