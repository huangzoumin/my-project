...
public class TestOwnerLogin {
    ...
    public static void main(String[] args){
        ...
        int port = 19091;
        String scheme = "http";
        String uriOfAPI = "/uaa/apid/plat/login";
        ...
        httpPost.setHeader("clientId","9iGpY_-BVshvOt0ZSMCQGKVlqD49M_jJC2ur-C4K");
        httpPost.setHeader("Origin","http://pt2.bccp.co:19091");
